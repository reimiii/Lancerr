    ...
    <div class="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
      ...
      <div class="p-5 rounded-t-xl text-center mt-5 mx-10">
        ...
        <p class="text-gray-400 mt-1 text-sm">
          Join Lancerr and start your real project
        </p>
      </div>
      <form method="POST" action="{{ route('register') }}">
        ...
        <div class="relative p-6 flex-auto mx-10">
          <div class="mb-4">
            ...
            @if($errors->has('name'))
            <p class="text-red-500 text-sm mb-3 italic">{{ $errors->first('name') }}</p>
            @endif
          </div>
          <div class="mb-4">
            ...
            @if($errors->has('email'))
            <p class="text-red-500 text-sm mb-3 italic">{{ $errors->first('email') }}</p>
            @endif
          </div>
          ...
          <div>
            ...
            <input
              ...
              id="password" type="password" name="password" placeholder="At least 8 characters" required>
            @if($errors->has('password'))
            <p class="text-red-500 text-sm mb-3 italic">{{ $errors->first('password') }}</p>
            @endif
          </div>
          ...
          <div>
            ...
            <p class="text-red-500 text-sm mb-3 italic">{{ $errors->first('password_confirmation') }}</p>
            @endif
          </div>
